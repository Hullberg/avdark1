...
SRC_URL='https://www.dropbox.com/s/rkdqc908nho6fd0/lab1.tar?dl=0'
...
if [ -e ${PIN_CURRENT} ]; then
	...
	wget -O "${COURSE_DIR}"/"${AVDARK_PIN_VERSION}.tar.gz" "${PIN_URL}"
	echo " done."

	echo "Decompressing PIN..."
	tar xvfz ${COURSE_DIR}/${AVDARK_PIN_VERSION}.tar.gz
